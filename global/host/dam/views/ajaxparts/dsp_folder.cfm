	...
	<div id="tabsfolder_tab">
		<ul>
			...
			<cfif attributes.iscol EQ "F">
				<li><a href="##content" onclick="loadcontent('content','#myself##xfa.fcontent#&folder_id=#attributes.folder_id#&kind=all&iscol=#attributes.iscol#');" rel="prefetch prerender">#myFusebox.getApplicationData().defaults.trans("folder_content")# (#arraysum(listtoarray(valuelist(qry_fileTotalAllTypes['cnt'])))#)</a></li>
