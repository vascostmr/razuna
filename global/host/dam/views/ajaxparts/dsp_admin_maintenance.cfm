		...
		<cfif !application.razuna.isp>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
				...
				<tr class="list">
					...
					<a href="#session.thehttp##cgi.http_host##cgi.script_name#?fusebox.loadclean=true&fusebox.password=razfbreload&fusebox.parseall=true&_v=#replace(createuuid(),'-','','all')#" target="_blank" style="text-decoration:none;"><input type="button" name="rebuiltcache" value="Flush template cache now" class="button" /></a>
					<br /><br />
					</td>
				</tr>
			</table>
