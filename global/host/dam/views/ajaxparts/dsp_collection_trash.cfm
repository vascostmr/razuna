	...
	<cfelse>
		<div id="tabsfolder_tab">
			<ul>
				...
				<li><a href="##collection" onclick="loadcontent('collection','#myself##xfa.ftrashcol#');" rel="prefetch prerender">#myFusebox.getApplicationData().defaults.trans("trash_folder_header")#(#arraySum(listToArray(valueList(col_count_trash.cnt)))#)<!---(#arraySum(col_count_trash['cnt'])#)---></a></li>
			</ul>
