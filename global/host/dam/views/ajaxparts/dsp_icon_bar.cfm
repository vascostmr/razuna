...
<div id="folderselection#kind#form" class="actiondropdown">
	...
	<cfif attributes.folderaccess IS NOT "R">
		<!--- RAZ-583: Link to folder(Hide the move files in select menu option)  --->
		...
		<!--- Check the folder permission AND RAZ-583: Link to folder(Hide the 'move to trash' in select menu option --->
