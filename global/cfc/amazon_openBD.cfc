...
<cfcomponent>
	...
	<cffunction name="registerDataSource" access="public" output="true">
		<cfargument name="datasource" type="string" required="true" />
		<cfargument name="awsaccess" type="string" required="true" />
		<cfargument name="awskey" type="string" required="true" />
		<cfargument name="region" type="string" required="true" />

		<cfset  returnVar = AmazonRegisterDataSource(arguments.datasource,arguments.awsaccess,arguments.awskey,arguments.region)>
