...
<cffunction name="getsettingsfromdam" returntype="query">
	<cfquery datasource="#application.razuna.datasource#" name="qry" cachedwithin="1" region="razcache">
	SELECT /* #variables.cachetoken#getsettingsfromdam */ set2_img_format, set2_img_thumb_width, set2_img_thumb_heigth, set2_date_format, set2_date_format_del, set2_intranet_reg_emails, set2_intranet_reg_emails_sub, set2_md5check, set2_email_from, set2_colorspace_rgb, set2_vid_preview_enable, set2_vid_player
	FROM #session.hostdbprefix#settings_2
	WHERE set2_id = <cfqueryparam value="#application.razuna.setid#" cfsqltype="cf_sql_numeric">
	AND host_id = <cfqueryparam cfsqltype="cf_sql_numeric" value="#session.hostid#">
	</cfquery>
...
<cffunction name="setsettingsfromdam" returntype="void">
	...
	set2_vid_preview_enable = <cfqueryparam value="#arguments.thestruct.set2_vid_preview_enable#" cfsqltype="cf_sql_varchar">,
	set2_vid_player = <cfqueryparam value="#arguments.thestruct.set2_vid_player#" cfsqltype="cf_sql_varchar">
	WHERE set2_id = <cfqueryparam value="#application.razuna.setid#" cfsqltype="cf_sql_numeric">
	AND host_id = <cfqueryparam cfsqltype="cf_sql_numeric" value="#session.hostid#">
	</cfquery>
	<!--- Flush --->
